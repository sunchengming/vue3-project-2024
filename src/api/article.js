...
//编辑文章分类
export const artEditChannelServer = (params)=>request.put('/my/cate/info',data)
...
// 根据id获取详情数据
export const artGetDetailServer = (id)=>request.get('/my/article/info',{
    params:{id}
})
...
//删除文章管理的文章
export const artDelServe = (id)=>request.delete('/my/article/info',{
    params:{id}
})
