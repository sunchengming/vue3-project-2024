...
// 上传用户头像
export const userAvatarUploadServer = (avatar)=>request.patch('/my/update/avatar',avatar)

// 用户密码修改
export const userPwdChangeServer = ({old_pwd,new_pwd,re_pwd})=>request.patch('/my/updatepwd',{old_pwd,new_pwd,re_pwd})
